...
const Index: FC<IndexProps> = ({ seo, descendants, filterMap }) => {
  ...
  const descendantCards = filteredDescendants.map(descendant => (
    <TFDLink
      ...
      path={`/builds/descendants/${kebabCase(descendant.descendant_name)}`}
...
export const getStaticProps = (async () => {
  ...
  const title = 'Descendant Builds | The First Descendant';
  const description = 'View all Descendant builds in The First Descendant (TFD)';
  const slug = '/builds/descendants';
